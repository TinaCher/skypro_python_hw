...
#Convert the input to a float: This ensures that even if the user inputs a decimal number, it will be handled correctly.
#Check if the number is an integer: We use int(square_side_float) to convert the float to an integer. If square_side_float is not equal to this integer value, it means the original number had a fractional part.
